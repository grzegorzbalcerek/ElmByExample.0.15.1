...
import Graphics.Element exposing (Element, centered, container, down, flow, leftAligned, layers, midRight, middle, right, spacer)
...
display state =
    collage 240 60 [
       ...
       toForm (container 220 50 midRight
                   (showState state |> Text.fromString |> leftAligned))
    ]
    ...
    container w h middle <|
        layers [
            ...
            flow down [
                    ...
                    flow right [ spacer 5 60, buttonPlus, button1
                               , button2, button3 ],
                    flow right [ spacer 5 60, buttonMinus, button4
                               , button5, button6 ],
                    flow right [ spacer 5 60, buttonMult, button7
                               , button8, button9 ],
                    flow right [ spacer 5 60, buttonDiv, button0
                               , buttonDot, buttonEq ]
                ]
            ]
